(function (e) {
    ...
    var m = function () {
    }, j = e.getOptions(), g = e.each, q = e.extend, n = e.wrap, h = e.Chart, i = e.seriesTypes, k = i.pie, l = i.column, r = HighchartsAdapter.fireEvent, t = HighchartsAdapter.inArray;
    q(j.lang, {drillUpText: "◁ Back to {series.name}"});
    ...
    h.prototype.showDrillUpButton = function () {
        var b = this, a = this.getDrilldownBackText(), c = b.options.drilldown.drillUpButton, d, f;
        this.drillUpButton ? this.drillUpButton.attr({text: a}).align() : (f = (d = c.theme) && d.states, this.drillUpButton = this.renderer.button(a, null, null,function () {
            b.drillUp()
        }, d, f && f.hover, f && f.select).attr({align: c.position.align, zIndex: 9}).add().align(c.position, !1, c.relativeTo || "plotBox"))
    };
    h.prototype.drillUp = function () {
        var b =
            this.drilldownLevels.pop(), a = this.series[0], c = b.oldExtremes, d = this.addSeries(b.seriesOptions, !1);
    ...
    k.prototype.animateDrilldown = function (b) {
        ...
        b || g(this.points, function (a, b) {
            ...
            a.graphic.attr(e.merge(d, {start: f + b * s, end: f + (b + 1) * s})).animate(a.shapeArgs, e.merge(c, {step: function (a, d) {
                d.prop === "start" && this.attr({fill: p(h, g, d.pos)})
            }}))
        })
    };
    ...
    l.prototype.animateDrillupFrom = k.prototype.animateDrillupFrom = function (b) {
        ...
        g(this.points, function (d) {
            ...
            f.animate(b.shapeArgs, e.merge(a, {step: function (a, c) {
                c.prop === "start" &&
                this.attr({fill: p(g, e.Color(b.color).rgba, c.pos)})
            }, complete: function () {
                f.destroy();
                c && (c = c.destroy())
            }}))
    ...
    n(e.Point.prototype, "init", function (b, a, c, d) {
    ...
    n(e.Series.prototype, "drawDataLabels", function (b) {
    ...
    for (o in i)i[o].prototype.supportsDrilldown && n(i[o].prototype, "drawTracker", j)
})(Highcharts);
